"""
Robomimic low-dimensional replay dataset (lift/can/square/transport).
...
class RobomimicReplayLowdimDataset(BaseLowdimDataset):
    def __init__(
        ...
        # Lazy import to avoid hard dependency when not using robomimic tasks
    ...
    def get_normalizer(self, **kwargs) -> LinearNormalizer:
        ...
        normalizer["obs"] = _normalizer_from_stat(obs_stat)
        return normalizer
...
def _data_to_obs(raw_obs, raw_actions, obs_keys, abs_action, rotation_transformer):
    ...
    return {"obs": obs, "action": raw_actions}

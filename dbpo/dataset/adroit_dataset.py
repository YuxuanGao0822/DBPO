"""
Adroit hand manipulation dataset (pen/hammer/door/relocate).

I/O: returns {"obs": {"point_cloud": [T,1024,6], "agent_pos": [T,D]}, "action": [T,Da]}
...
class AdroitDataset(BaseLowdimDataset):
    def __init__(
        self,
        zarr_path,
        horizon=1,

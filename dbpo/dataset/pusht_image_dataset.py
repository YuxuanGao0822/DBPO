...
I/O: returns {"obs": {"image": [T,3,96,96], "agent_pos": [T,2]}, "action": [T,2]}
...
from dbpo.dataset.normalize_util import get_image_range_normalizer
...
class PushTImageDataset(BaseImageDataset):
    ...
    def _sample_to_data(self, sample):
        ...
        image = np.moveaxis(sample["img"], -1, 1) / 255.0  # T,H,W,C -> T,C,H,W, float
        return {
